...
export const products = [
  ...
  },
  {
    ...
    hero: {
      ...
      subtitle:
        'Standup captures, transcribes and remembers your meetings — turning scattered conversations into a single, searchable source of truth your whole team can rely on.',
      ctaPrimary: { label: 'Get started', href: 'https://standup.gnanalytica.com' },
    ...
    closing: {
      ...
      subtitle:
        'Give your team a persistent memory that turns meetings from time spent into knowledge kept.',
      cta: { label: 'Get started', href: 'https://standup.gnanalytica.com' },
    },
  },
  {
    slug: 'learn',
